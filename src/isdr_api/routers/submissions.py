...
def create_submission(
    ...
    """
    if payload.mode == "spontaneous_image" and not (payload.image_prompt_url and payload.image_prompt_url.strip()):
        raise HTTPException(
            status_code=400,
            detail="An image_prompt_url is required for image-based recording submissions",
        )
